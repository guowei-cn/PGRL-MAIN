...
pattern_003_ACC_ASR = [
    ...
    (0.77, 0.63),   (0.897, 0), # moved from 5th-from-last
    (0.90, 0.016), (0.90, 0.093), # CT(0.86, 0.11),
    (0.92, 0.77), (0.92, 0.97), (0.92, 0.01), (0.91, 0.004) # ESTI (0.897, 0)
]

pattern_05_ACC_ASR = [
    (0.86, 0.00), (0.88, 0.00), (0.93, 0.006),
    (0.85, 0.09), (0.917, 0.00), # moved
    (0.91, 0.038), (0.93, 0.00), #CT(0.88, 0.09),
    (0.92, 0.04), (0.92, 0.99), (0.91, 0.01), (0.92, 0.006) # ESTI (0.917, 0.00)
]
# pattern in imagenette
# pattern_003_ACC_ASR = [
#     (0.889, 0.910), (0.91, 0.990), (0.876,0.972),
#     (0.82, 0.83),  # moved from 5th-from-last
#     (0.905, 0.018), (0.8611, 0.070), (0.75, 0.02),
#     (0.87, 0.69), (0.910, 1.00), (0.90, 0.024), (0.910, 0.004)
# ]
#
# pattern_05_ACC_ASR = [
#     (0.895,0.053), (0.88,0.040), (0.8858, 0.099),
#     (0.811, 0,.087),  # moved
#     (0.893, 0.027), (0.86, 0.065), (0.80, 0.05),
#     (0.88, 0.08),  (0.910, 1.00),  (0.905, 0.021), (0.910,0.001)
# ]

adapblend_003_ACC_ASR = [
    (0.91, 0.82), (0.93, 0.87), (0.86, 0.77),
    (0.68, 0.64), (0.8596, 0.0), # moved
    (0.90, 0.01), (0.93, 0.58), #CT (0.74, 0.65),
    (0.91, 0.84), (0.92, 0.05), (0.94, 0.82), (0.91, 0.006) # ESTI (0.8596, 0.0)
]

adapblend_05_ACC_ASR = [
    (0.85, 0.93), (0.93, 0.84), (0.93, 0.72),
    (0.78, 0.95), (0.8596, 0.0), # moved
    (0.90, 0.08), (0.92, 0.69), #CT(0.73, 0.82),
    (0.91, 0.86), (0.92, 0.08), (0.92, 0.01), (0.93, 0.009) # ESTI (0.897, 0.64)
]

freq_500_003_ACC_ASR = [
    (0.87, 0.82), (0.87, 0.91), (0.92, 0.75),
    (0.79, 0.10), (0.8596, 0.0), # moved
    (0.91, 0.89), (0.92, 0.75), #CT(0.87, 0.96),
    (0.92, 0.98), (0.93, 0.70), (0.92, 0.09), (0.92, 0.007) # ESTI (0.8975, 0.0)
]

freq_500_05_ACC_ASR = [
    (0.88, 0.04), (0.87, 0.08), (0.88, 0.00),
    (0.86, 0.11), (0.8596, 0.0), # moved
    (0.90, 0.95), (0.92, 0.95), #CT(0.84, 0.10),
    (0.92, 0.97), (0.92, 0.91), (0.91, 0.01), (0.92, 0.006) # ESTI (0.9164, 0.0)
]
...
plt.savefig('cifar10_asr_acc.png', dpi=800)
plt.close()
