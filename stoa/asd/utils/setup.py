...
def get_saved_dir(config, inner_dir, config_name):
    ...
    if os.path.exists(saved_dir):
        ...
        # shutil.rmtree(saved_dir) # remove all existiing files
        # exit()
...
def get_storage_dir(config, inner_dir, config_name):
...
def get_logger(log_dir, log_name, is_rank0=True):
