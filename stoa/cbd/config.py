...
def get_arguments():
    ...
    parser.add_argument('--dataset', type=str, default='imagenette_adaptivecifar10', help='name of image dataset')
    parser.add_argument('--inject_portion', type=float, default=0.05, help='ratio of backdoor samples')
